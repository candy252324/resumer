...
/***/ function(module, exports, __webpack_require__) {
	...
	var s = '我是一个喜欢钻研，有自主学习能力的人。 工作认真，能接受挑战也能承受压力。' + '喜欢研究所碰到的各种技术问题，并且执行力强，有新的想法就马上付诸行动去实现。' + '我有时间概念，能在约定时间内保证完成任务。' + '希望在一个以技术为驱动、有成长空间的公司里从事前端开发工作，不断迎接技术上的挑战，提升自己驾驭大型项目的能力。';
	var con = $('.typer');
	var index = 0;
	var length = s.length;
	var tId = null;
